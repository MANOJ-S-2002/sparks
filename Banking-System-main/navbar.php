<!-- navbar --> 
      ...
      <a class="navbar-brand" href="index.php" style="color : #000000;"><b>DJANGO BANK</b></a>
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="createuser.php" style="color : black;"><b>Create User</b></a>
              </li>
              <li class="nav-item">
       ...
       <style>
         .navbar {
           background-color:#44cc29  !important;
}
       </style>
